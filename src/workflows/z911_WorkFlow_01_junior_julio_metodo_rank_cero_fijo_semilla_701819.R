# Auto-generated untouched execution script for z911_WorkFlow_01_junior_julio (metodo rank_cero_fijo) semilla 701819.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 701819

PARAM$experimento <- "semilla_701819-rank_cero_fijo"
