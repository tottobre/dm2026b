# Auto-generated untouched execution script for z911_WorkFlow_01_junior_julio (metodo rank_cero_fijo) semilla 900001.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 900001

PARAM$experimento <- "semilla_900001-rank_cero_fijo"
