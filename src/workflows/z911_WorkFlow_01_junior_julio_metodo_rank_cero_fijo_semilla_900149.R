# Auto-generated untouched execution script for z911_WorkFlow_01_junior_julio (metodo rank_cero_fijo) semilla 900149.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 900149

PARAM$experimento <- "WFsemilla_900149-rank_cero_fijo"
