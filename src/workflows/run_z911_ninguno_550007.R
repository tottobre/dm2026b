# Untouched execution script for z911_WorkFlow_01_junior_julio (ninguno)- semilla 550007.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 550007

PARAM$experimento <- "ssemilla_550007-ninguno"
