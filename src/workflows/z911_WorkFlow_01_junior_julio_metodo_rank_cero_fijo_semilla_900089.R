# Auto-generated untouched execution script for z911_WorkFlow_01_junior_julio (metodo rank_cero_fijo) semilla 900089.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 900089

PARAM$experimento <- "semilla_900089-rank_cero_fijo"
