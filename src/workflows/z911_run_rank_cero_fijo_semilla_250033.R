# Auto-generated untouched execution script for z911_WorkFlow_01_junior_julio (metodo rank_cero_fijo) semilla 250033.ipynb
...
# --- CELL 11 ---
PARAM <- list()
PARAM$semilla_primigenia <- 250033

PARAM$experimento <- "WFsemilla_250033-rank_cero_fijo"
