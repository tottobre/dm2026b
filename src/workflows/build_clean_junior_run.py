...
out_r = "/Users/tomas/Dev/dm2026b/src/workflows/z910_junior_clean_run.R"
...
# 3. Update Cell 67: BO Optimization (mlrMBO)
bo_code = [
...
# 4. Replace cells 78 to 87 with Semillerío + explicit param_final assignment
c_78 = {
    "cell_type": "markdown",
    "metadata": {},
    "source": [
...
# Rebuild R script
r_code = ["# Auto-generated executable R script for clean junior BO + ensemble run\n"]
...
print("CLEAN JUNIOR WORKFLOW SCRIPT CREATED SUCCESSFULLY!")
